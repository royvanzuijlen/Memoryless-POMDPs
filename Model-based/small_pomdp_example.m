...
legend({'Brute force','Model-based Policy iteration','Policy gradient'},'location','southeast')
xlim([0,n_iter]); xticks(0:5:n_iter);
set(gcf,'renderer','painters','position',[680 557 313 250])
ylim([3.3 3.65])
